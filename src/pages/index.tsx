      ...
      <main>
        <section className="relative h-screen">
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-center text-white z-10 px-4 text-center">
            ...
            <motion.h2
              className="font-danjo text-3xl sm:text-5xl md:text-5xl font-normal mb-5 md:mb-7 leading-snug md:leading-[1.3] tracking-wide text-center drop-shadow-[0_8px_18px_rgba(0,0,0,0.25)]"
              animate="visible"
