export const ceoText = {
  KOR: {
    ...
    paragraphs: [
      "안녕하십니까.",
      "㈜수만은 자동차 및 전기전자, 이차전지 정밀 부품, 모듈, 장비 제조 등의 사업 분야 확대에 성공하여 꾸준한 성장을 거듭하고 있는 기술력과 Know-how를 보유한 기업입니다.",
      " ",
      "㈜수만은 끊임없는 기술 혁신과 철저한 품질 관리를 통하여 고객이 신뢰할 수 있는 제품을 공급해왔으며 변화하는 산업 속에서도 유연하고 정직한 기술력으로 지속가능한 성장을 이어가고 있습니다.",
      " ",
      "앞으로도 ㈜수만은 고객의 성공과 함께하는 든든한 파트너가 되겠습니다.",
      "변함 없는 관심과 많은 성원 부탁드립니다.",
      "감사합니다.",
    ],
    closing: null,
