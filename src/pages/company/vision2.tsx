...
<section className="bg-[#0A1633] w-full">
  ...
  {/* Headline bilingual */}
  <h2 className="text-white text-2xl md:text-3xl font-bold leading-tight mb-2 text-left">
    ...
    <br />
    <span className="block mt-4 text-white text-base md:text-lg font-semibold">
