...
const orgData = {
  ...
  ENG: {
    ...
    departments: [
      ...
      {
        name: "Manufacturing",
        teams: ["Design", "Production 1 (Processing)", "Production 2 (Assembly)"]
      },
      {
        name: "New Business",
            ...
            >
              ...
              <motion.div variants={itemVariants}>
                <div className="bg-gray-50 border border-gray-300 rounded-[30px] px-8 py-4 flex items-center gap-3 shadow-sm">
                  ...
                  />
                  <span className="text-lg font-bold text-blue-800">SUMAN</span>
                </div>
              </motion.div>
              ...
              {/* CEO and Advisor */}
              <motion.div className="relative flex justify-center w-full" variants={itemVariants}>
                ...
                <div className="absolute left-[calc(50%+60px)] top-1/2 -translate-y-1/2 flex items-center z-0">
                  ...
                  <div className="border border-gray-400 bg-white px-4 py-2 rounded-lg font-medium text-gray-600 text-sm">
                    {currentOrgData.advisor}
                  </div>
                </div>
                {/* CEO card on top */}
                <div className="bg-[#1E3A5F] text-white px-14 py-3 rounded-lg font-semibold text-lg z-10 relative">
                  {currentOrgData.ceo}
                </div>
              </motion.div>
              ...
              <svg width="900" height="50" className="overflow-visible">
                ...
                <line x1="90" y1="0" x2="810" y2="0" stroke="#9CA3AF" strokeWidth="2"/>
                {/* Vertical lines down to each department */}
                <line x1="90" y1="0" x2="90" y2="50" stroke="#9CA3AF" strokeWidth="2"/>
                <line x1="270" y1="0" x2="270" y2="50" stroke="#9CA3AF" strokeWidth="2"/>
                <line x1="450" y1="0" x2="450" y2="50" stroke="#9CA3AF" strokeWidth="2"/>
                <line x1="630" y1="0" x2="630" y2="50" stroke="#9CA3AF" strokeWidth="2"/>
                <line x1="810" y1="0" x2="810" y2="50" stroke="#9CA3AF" strokeWidth="2"/>
              </svg>
                      ...
                      {dept.teams.map((team, teamIndex) => (
                        <div 
                          ...
                          className={`px-2 py-4 text-center text-sm text-gray-700 ${
                            teamIndex !== dept.teams.length - 1 ? 'border-b border-gray-200' : ''
                          }`}
                        >
                          {team}
                        </div>
